...
background-image: url(img/saurus_plot.png)
...
class: clear, center, middle
background-image: url(img/sticker_graphics_package.png)
...
class: clear, center, middle
background-image: url(img/ggpubr.png)
...
background-image: url(img/variables.png)
background-size: 700px
background-position: 50% 50%
...
background-image: url(img/ggplot2_2.png)
background-size: 500px
background-position: 50% 50%
...
datasaurus_dozen %>% 
    ...
    ggplot() +
    aes(x = x, y = y) +
    geom_point(colour = "black", fill = "forest green", 
...
background-image: url(img/ram_logo.jpg)
background-size: 600px
background-position: 50% 50%
