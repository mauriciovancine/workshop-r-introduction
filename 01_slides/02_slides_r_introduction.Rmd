...
subtitle: "2 Estrutura e manipulação de dados"
...
```{r echo=FALSE}
read.csv(here::here("03_dados", "ATLANTIC_AMPHIBIANS_sites.csv"), encoding = "latin1")
```
...
```{r echo=FALSE}
da <- read.csv(here::here("03_dados", "ATLANTIC_AMPHIBIANS_sites.csv"), encoding = "latin1")
```
...
```{r include=FALSE}
# ler e atribuir uma planilha eletronica (.csv) a um objeto
da <- read.csv("/home/mude/data/github/workshop-r-introduction/03_dados/ATLANTIC_AMPHIBIANS_sites.csv",
               encoding = "latin1")
```
