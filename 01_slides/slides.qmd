...
Representa combinação de tabelas, com linhas (locais), colunas (variáveis) e dimensões (tempo)
...
# Se preparem para finalmente entender funções compostas...
...
# 
<center>
<img src="img/meme_fake_news.jpg" style="width:60%"/>
</center>

:::footer
[Corações e Mentes](https://coracoesementes.org.br/)
:::
...
<center>
<img src="img/plot_tree_s.png" style="width:30%"/>
</center>
...
![](img/plot_variables.png){.absolute width=400 height=200 right=300 top=100}

![](img/nominal_ordinal_binary.png){.absolute width=500 height=350 right=500 top=300}

![](img/continuous_discrete.png){.absolute width=500 height=350 right=0 top=300}
...
ggsave(filename = here::here("03_dados", "graficos", "density_ggplot2.png"), 
...
```{r}
#| eval: false
gganimate::anim_save(filename = "03_dados/graficos/plot_animate.gif",
...
htmlwidgets::saveWidget(widget = plot_penguins_scatter_int, 
                        file = "03_dados/graficos/plot_penguins_scatter_int.html")
```
...
:::footer
Slides por [Maurício Vancine](https://mauriciovancine.github.io/), feitos com [Quarto](https://quarto.org/). Código disponível no [GitHub](https://github.com/mauriciovancine/workshop-intro-r/01_slides/slides.qmd).
:::