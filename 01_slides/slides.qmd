...
- Meu principal intuito, no entanto, é fazer uma sólida introdução

- Vou indicar muito material para estudo

- É muito difícil aprender apenas com cursos
...
# Se preparem para uma revisão de funções compostas fog() e gof()
