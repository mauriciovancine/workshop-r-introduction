...
### 2 Funcionamento da linguagem R (1 h)
...
### 3 Estrutura e manipulação de objetos  (2 h)

1. Atributo dos objetos
1. Manipulação de objetos unidimensionais
1. Manipulação de objetos multidimensionais
1. Valores faltantes e especiais
1. Diretório de trabalho
1. Importar dados
1. Conferência dos dados importados
1. Exportar dados
...
### 5 Visualização de dados (2 h)

1. Principais pacotes
1. Grámatica dos gráficos
1. Tipos de gráficos
1. Finalização de gráficos para publicação
